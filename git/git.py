...
class TaskManager:
    ...
    def list_tasks(self):
        ...
        for task in self.tasks:
            ...
            print(f'{task.id}. {task.title} [{status_str}] (Приоритет: {task.priority}, Срок: {task.due_date})')
...
def tasks_menu():
    ...
    while True:
        ...
        elif choice == "6":manager.export_tasks_to_csv()

        elif choice == "7":manager.import_tasks_from_csv()

        elif choice == "8":break

        else:print("Некорректный выбор. Попробуйте снова.")
